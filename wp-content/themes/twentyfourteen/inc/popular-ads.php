<?php
class My_theme_widget_popular_ads extends WP_Widget {

	function __construct() {
		parent::__construct(
			'popular_ads_widget', // Base ID
			__('Show post popular ads', 'popular_ads'), // Name
			array( 'description' => __( 'Info contact and save contact widget', 'popular_ads' ), ) // Args
		);
	}
